...
public class MainMenu {
    public static final String ITEM_0 = "Завершить выполнение программы.";
    public static final String ITEM_1 = "Добавить продукт";
    public static final String ITEM_2 = "Поиск продукта по ID";
    public static final String ITEM_3 = "Отобразить все продукты";
