...
public class SetProductMethods {
    public static String setNameNewProduct() {
    ...
    public static Category setCategoryNewProduct() {
    ...
    private static Category getCategory(String categoryStringNewProduct) {
        ...
        setCategoryNewProduct();
        return null;
    }

    public static String setDescriptionNewProduct() {
    ...
    private static void checkLengthDescription(String descriptionNewProduct) {
        if(descriptionNewProduct.length() == 0) {
            ...
            setDescriptionNewProduct();
        }
    }

    public static BigDecimal setPriceNewProduct() {
    ...
    public static BigDecimal setDiscountNewProduct() {
